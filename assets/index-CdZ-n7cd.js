...
${e?`  <div class="space-y-2">
  ...
  `);return r}function C(){let e=()=>o(`
    ...
    </div>`);a({component:e}).render()}const w=()=>r(async()=>{let{worker:e,workerOptions:t}=await import(`./browser-DK6whEil.js`);return{worker:e,workerOptions:t}},[]).then(({worker:e,workerOptions:t})=>e.start(t));function T(){let e=[{pathname:`/`,component:x,matchPattern:`^${i}/$`},{pathname:`/product/:productId`,component:s,matchPattern:`^${i}/product/[A-Za-z0-9_-]+$`},{pathname:`*`,component:C,matchPattern:`^${i}.*$`}],t=()=>{let t=location.pathname,n=e.find(e=>{let n=new RegExp(e.matchPattern);return n.test(t)});return n?n.component:null};h.onChange(()=>{let e=t()();console.log(e)});let n=t()();console.log(n)}w().then(T);