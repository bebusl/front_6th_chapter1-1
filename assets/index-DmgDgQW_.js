...
${e?`  <div class="space-y-2">
  ...
  `);return r}function S(){let e=()=>a(`
    ...
    </div>`);i({component:e}).render()}const C=()=>r(async()=>{let{worker:e,workerOptions:t}=await import(`./browser-EepaDAeu.js`);return{worker:e,workerOptions:t}},[]).then(({worker:e,workerOptions:t})=>e.start(t));function w(){let e=[{pathname:`/`,component:b,matchPattern:`^/$`},{pathname:`/product/:productId`,component:o,matchPattern:`^/product/[A-Za-z0-9_-]+$`},{pathname:`*`,component:S,matchPattern:`^.*$`}],t=()=>{let t=location.pathname,n=e.find(e=>{let n=new RegExp(e.matchPattern);return n.test(t)});return n?n.component:null};m.onChange(()=>{let e=t()();console.log(e)});let n=t()();console.log(n)}C().then(w);